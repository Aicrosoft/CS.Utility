...
namespace CS.Data
{
    ...
    /// <para>Note:如果自已在外部打开了Connection对象一定要自已关闭。没有外部打开的，本SqlHelper会自已关闭。-by zhouyu</para>
    /// <para>Note:使用ExecuteReader时必须自已管理连接对象的开闭。</para>
    /// </summary>
    public static class SqlHelper
    {
        ...
        public static object ExecuteScalar(SqlTransaction transaction, string spName, params object[] parameterValues)
        {
            ...
            var commandParameters = SqlHelperParameterCache.GetSpParameterSet(transaction.Connection,
                                                                              spName);
    ...
    public static class SqlHelperParameterCache
    {
        ...
        private static readonly Hashtable paramCache = Hashtable.Synchronized(new Hashtable());   //hash表是最快的
